...
//        awesomeValidation.addValidation(this, R.id.index, "[1][6][0-9]", R.string.invalid_phone); //meka hadapan
//        awesomeValidation.addValidation(this, R.id.index, "[1][6][0-9]{4}[a-zA-Z]",
